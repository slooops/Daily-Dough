      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        >
          ...
          <View style={{ gap: 6, marginTop: 8 }}>
            ...
            <Text style={styles.muted}>
              • OR if spent_today &gt; daily_allowance AND slush after applying
              today ≥ 0
            </Text>
            <Text style={styles.muted}>
        ...
        <View style={styles.card}>
          ...
          <Text style={[styles.muted, { marginTop: 6 }]}>
            Your slush pot collects 100% of daily over/under to smooth spending
            bumps.
          </Text>
          <View
            style={[
          ...
          >
            <Text style={styles.muted}>
              Example: Allowance $100, spent $112 → over $12 → Slush reduces by
              $12
            </Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={{ gap: 6, marginTop: 8 }}>
            <Text style={styles.muted}>
              • If slush &gt; 0: choose to keep it or send to savings (default:
              keep)
            </Text>
            <Text style={styles.muted}>
